...
`;function V({name:e,row:t,expanded:n=!1,expandableIcon:o,id:a,keyField:l,rowCount:i,onExpandedRow:s,handleExpanded:d,expandableRowsSingle:c,expandableRowDisabled:g}){const p=!(!g||!g(t));return r.createElement(G,{onClick:e=>e.stopPropagation(),noPadding:!0},r.createElement(B,{name:e,id:a,row:t,expanded:n,expandableIcon:o,disabled:p,onToggled:()=>{s({type:"EXPAND_SINGLE_ROW",row:t,isExpanded:n,keyField:l,rowCount:i,singleExpand:c}),d()}}))}const U=s.default.div`
	width: 100%;
	box-sizing: border-box;
