...
`;function z({name:t,row:n,expanded:o=!1,expandableIcon:a,id:l,keyField:r,rowCount:i,onExpandedRow:s,handleExpanded:d,expandableRowsSingle:c,expandableRowDisabled:g}){const p=!(!g||!g(n));return e.createElement(N,{onClick:e=>e.stopPropagation(),noPadding:!0},e.createElement(M,{name:t,id:l,row:n,expanded:o,expandableIcon:a,disabled:p,onToggled:()=>{s({type:"EXPAND_SINGLE_ROW",row:n,isExpanded:o,keyField:r,rowCount:i,singleExpand:c}),d()}}))}const W=n.div`
	width: 100%;
	box-sizing: border-box;
