...
`;function B({name:e,row:t,expanded:n=!1,expandableIcon:o,id:a,keyField:r,rowCount:i,onExpandedRow:s,handleExpanded:d,expandableRowsSingle:c,expandableRowDisabled:g}){const p=!(!g||!g(t));return l.createElement(W,{onClick:e=>e.stopPropagation(),noPadding:!0},l.createElement(z,{name:e,id:a,row:t,expanded:n,expandableIcon:o,disabled:p,onToggled:()=>{s({type:"EXPAND_SINGLE_ROW",row:t,isExpanded:n,keyField:r,rowCount:i,singleExpand:c}),d()}}))}const G=i.default.div`
	width: 100%;
	box-sizing: border-box;
