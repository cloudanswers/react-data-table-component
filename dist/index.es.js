...
`,ne=n.div`
	...
	white-space: nowrap;
	text-overflow: ellipsis;
`;var oe=e.memo((function({column:t,disabled:n,draggingColumnId:o,selectedColumn:a={},sortDirection:r,sortIcon:i,sortServer:s,pagination:d,paginationServer:c,persistSelectedOnSort:g,selectableRowsVisibleOnly:p,onSort:u,onDragStart:b,onDragOver:w,onDragEnd:m,onDragEnter:h,onDragLeave:f,currentSortColumnId:C,currentSortDirection:R}){e.useEffect((()=>{"string"==typeof t.selector&&console.error(`Warning: ${t.selector} is a string based column selector which has been deprecated as of v7 and will be removed in v8. Instead, use a selector function e.g. row => row[field]...`)}),[]);const[E,y]=e.useState(!1),v=e.useRef(null);if(e.useEffect((()=>{v.current&&y(v.current.scrollWidth>v.current.clientWidth)}),[E]),t.omit)return null;const S=()=>{if(!t.sortable&&!t.selector)return;let e=r;x(a.id,t.id)&&(e=r===l.ASC?l.DESC:l.ASC),u({type:"SORT_CHANGE",sortDirection:e,selectedColumn:t,clearSelectedOnSort:d&&c&&!g||s||p})},O=t=>e.createElement(Q,{sortActive:t,sortDirection:null!=R?R:r}),k=()=>e.createElement("span",{className:[r,"__rdt_custom_sort_icon__"].join(" ")},i),P=null!==C?!(!t.sortable||!x(C,t.id)):!(!t.sortable||!x(a.id,t.id)),D=!t.sortable||n,F=t.sortable&&!i&&!t.right,H=t.sortable&&!i&&t.right,$=t.sortable&&i&&!t.right,j=t.sortable&&i&&t.right;return e.createElement(Z,{"data-column-id":t.id,className:"rdt_TableCol",headCell:!0,allowOverflow:t.allowOverflow,button:t.button,compact:t.compact,grow:t.grow,hide:t.hide,maxWidth:t.maxWidth,minWidth:t.minWidth,right:t.right,center:t.center,width:t.width,draggable:t.reorder,isDragging:x(t.id,o),onDragStart:b,onDragOver:w,onDragEnd:m,onDragEnter:h,onDragLeave:f},t.name&&e.createElement(te,{"data-column-id":t.id,"data-sort-id":t.id,role:"columnheader",tabIndex:0,className:"rdt_TableCol_Sortable",onClick:D?void 0:S,onKeyPress:D?void 0:e=>{"Enter"===e.key&&S()},sortActive:!D&&P,disabled:D},!D&&j&&k(),!D&&H&&O(P),"string"==typeof t.name?e.createElement(ne,{title:E?t.name:void 0,ref:v,"data-column-id":t.id},t.name):t.name,!D&&$&&k(),!D&&F&&O(P)))}));const ae=n(D)`
	flex: 0 0 48px;
	justify-content: center;
	align-items: center;
	user-select: none;
